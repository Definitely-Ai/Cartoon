...
- **Faces do little and mean much**: keep acting restrained and specific with small mouths or beak openings, controlled lids and brows, and no grimaces. Species-specific eye, lid, muzzle, beak, and mouth construction comes from each locked model sheet; never replace it with a generic dot-eye system or human facial anatomy. Barclay specifically uses visible paper-white sclera, a separate gray iris, a separate black pupil, and controlled catchlights so his gaze and emotion remain readable; this detail stays restrained and monochrome. The gag is in gaze, posture, and placement, not exaggerated reaction faces.
