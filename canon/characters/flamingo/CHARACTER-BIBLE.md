...
| Drink | Martini — conical stemmed glass, olives on a pick |
| Frame position | Frame-left by default |
| Value note | He is the **brightest object in the panel**; the paper's white is reserved for him |
...
- **Sleeves end at the elbow** so what shows below is feathers, never arm.
...
plate is the measure. Never straight, never goose-stiff, never short and
thick.
...
drooping upper lid, a drawn brow. They read as dry, unimpressed intelligence.
Never a flat bird-dot.
...
| Trousers | Yes *(founder: "he needs to have pants")* |
