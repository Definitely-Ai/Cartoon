...
- A LETTERED bottle: every bottle on the shelves wears a deliberately wordless label (see the master prompt) — never invent a name, a number or a mark that reads as writing
