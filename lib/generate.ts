  ...
  if (barScene && list.length < LIMIT) {
    list.push({
      ...
      label:
        ...
        "COUNTER IN THIS TILE IS THE COUNTER, its edges as HORIZONTAL as drawn here, the same height beside each gentleman " +
        "as in front of him: seat the gentlemen on the NEAR side of THIS counter SEEN FROM BEHIND, with their " +
