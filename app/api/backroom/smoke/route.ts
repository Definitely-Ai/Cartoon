...
const SET_PLATE_PROMPT =
  ...
  "CENTRE, HIGH ON THE WALL ABOVE THE BACK BAR, a modern wall-mounted FLAT-SCREEN TELEVISION with a NARROW " +
  "black bezel — a television, not a picture frame. ITS SCREEN IS COMPLETELY BLANK: an empty pale rectangle " +
  "with no picture, no headline band, no letters and no marks of any kind, and no badge or nameplate on its " +
  "frame.\n" +
  "RIGHT OF THE TELEVISION, a CHALKBOARD in a dark wooden frame on the panelling. IT IS COMPLETELY BLANK — an " +
  "empty dark slate, no chalk writing, no words, no numbers, no marks.\n" +
  "A brass wall sconce with a small pleated shade at each end of the back bar.\n" +
...
const SHOWCASE: Panel[] = [
  {
    ...
    candidate: {
      scene:
        "The bar is otherwise completely empty and the two of them are crammed into one corner of it, sharing a single stretch of marble with the nut bowl wedged between them, Mango's elbow already surrendered — stage on the counter, not the foot rail. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two of them, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble counter runs across the MIDDLE of the picture BEHIND their shoulders, their drinks standing on it past their arms. Beyond it is the bar: back bar, bottles, mirror, the television above and the chalkboard beside. They are patrons — never behind the bar, never holding a bottle or a bar towel. The television picture shows A cabin cross-section, three seats abreast, drawn with no aisle anywhere in it. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Abby sets Drew's martini in front of him — a long three-olive pick carrying exactly one olive, which is this panel's one licensed exception to the three-olive rule — and screws the lid back onto the olive jar before it goes below the counter. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two gentlemen, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble runs across the MIDDLE of the picture BEHIND their shoulders. BEYOND it stands ABBY, facing them across the bar, the counter's far edge crossing in front of her at the waist and hiding her below it — she is standing and they are seated, so her head sits HIGHER in the frame than theirs. Behind her, the back bar, the television above it and the chalkboard beside. The television picture shows A checkout belt carrying four items and a receipt long enough to hang off the end of it. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Mango has taken his hand off his glass and laid it flat over his flag pin, eyes on the screen, and the posture must read as entirely sincere — never comic — while Drew, mid-sip, watches Mango rather than the television. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two of them, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble counter runs across the MIDDLE of the picture BEHIND their shoulders, their drinks standing on it past their arms. Beyond it is the bar: back bar, bottles, mirror, the television above and the chalkboard beside. They are patrons — never behind the bar, never holding a bottle or a bar towel. The television picture shows A trading floor with every head turned the same direction and nobody moving. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Abby slides Mango's old fashioned across the marble — one large cube, one dark cherry — past the check spindle, where a renewal envelope thick as a paperback is spiked and still sealed, tall enough to bury the spindle. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two gentlemen, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble runs across the MIDDLE of the picture BEHIND their shoulders. BEYOND it stands ABBY, facing them across the bar, the counter's far edge crossing in front of her at the waist and hiding her below it — she is standing and they are seated, so her head sits HIGHER in the frame than theirs. Behind her, the back bar, the television above it and the chalkboard beside. The television picture shows A small tidy house standing behind a mailbox too full to close — no people in the shot. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Away game — the club grill room after nine: Drew's phone lies face-down on the bar under one economical feather-digit with a signed chit beside it, while Mango is still in his cap with his glove tucked in his belt. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two of them, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble counter runs across the MIDDLE of the picture BEHIND their shoulders, their drinks standing on it past their arms. Beyond it is the bar: back bar, bottles, mirror, the television above and the chalkboard beside. They are patrons — never behind the bar, never holding a bottle or a bar towel. The television picture shows One chart carrying two lines, both going the same way down. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Away game — the customer lounge of a truck dealership: Mango turns his key fob over and over on the finance desk with a folded rate sheet pinned under his elbow, his own truck parked outside the showroom glass behind him, while Drew holds a styrofoam cup of the dealership's coffee at arm's length, untasted. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two of them, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble counter runs across the MIDDLE of the picture BEHIND their shoulders, their drinks standing on it past their arms. Beyond it is the bar: back bar, bottles, mirror, the television above and the chalkboard beside. They are patrons — never behind the bar, never holding a bottle or a bar towel. The television picture shows A bank's loan-rate sign being changed by a man on a stepladder. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Mango tips the top inch of his old fashioned into an empty glass, sets that glass firmly aside, and only then lifts his own; Drew watches with mild interest. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two of them, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble counter runs across the MIDDLE of the picture BEHIND their shoulders, their drinks standing on it past their arms. Beyond it is the bar: back bar, bottles, mirror, the television above and the chalkboard beside. They are patrons — never behind the bar, never holding a bottle or a bar towel. The television picture shows A house standing in a puddle beneath a very small umbrella. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Drew's glass is already up toward the screen while Mango turns the bar's wall calendar forward a page with one broad finger. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two of them, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble counter runs across the MIDDLE of the picture BEHIND their shoulders, their drinks standing on it past their arms. Beyond it is the bar: back bar, bottles, mirror, the television above and the chalkboard beside. They are patrons — never behind the bar, never holding a bottle or a bar towel. The television picture shows A policy-rate staircase with the final step already drawn in and inked solid. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Mango reads from a receipt long enough that the end of it hangs over the edge of the marble, and Drew has stopped his martini halfway up, head tilted toward the reading with the courteous attention of a man hearing an away score come in. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two of them, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble counter runs across the MIDDLE of the picture BEHIND their shoulders, their drinks standing on it past their arms. Beyond it is the bar: back bar, bottles, mirror, the television above and the chalkboard beside. They are patrons — never behind the bar, never holding a bottle or a bar towel. The television picture shows One paper grocery sack sitting on a butcher's scale. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Mango holds a long register receipt flat across the marble with both hands, the way a man holds a treaty, while Drew reads it upside down from his side without lowering his martini. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two of them, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble counter runs across the MIDDLE of the picture BEHIND their shoulders, their drinks standing on it past their arms. Beyond it is the bar: back bar, bottles, mirror, the television above and the chalkboard beside. They are patrons — never behind the bar, never holding a bottle or a bar towel. The television picture shows A department-store floor under a SALE banner, the manager shaking hands with a customs officer. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Abby is mid-pour from a labelled bottle into Mango's rocks glass, towel on her left shoulder and eyes down on the work, while Mango turns to Drew to say it and Drew's eye stays on the label. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two gentlemen, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble runs across the MIDDLE of the picture BEHIND their shoulders. BEYOND it stands ABBY, facing them across the bar, the counter's far edge crossing in front of her at the waist and hiding her below it — she is standing and they are seated, so her head sits HIGHER in the frame than theirs. Behind her, the back bar, the television above it and the chalkboard beside. The television picture shows Two lecterns in two different rooms, filmed at the same height, the same empty chairs behind each. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
  ...
  },
  {
    ...
    candidate: {
      scene:
        "Abby sets the bar check down between them and goes back to her towel; Mango takes it in both hands at reading distance while Drew, martini at rest, does not touch it and plainly is not going to. CAMERA: we are in the DINING ROOM, BEHIND AND SLIGHTLY ABOVE the two gentlemen, looking OVER THEIR SHOULDERS toward the bar. Drew sits frame-left and Mango frame-right with their BACKS TO US, each turned toward the other so his face reads in three-quarter over his own shoulder; their near shoulders OVERLAP AND HIDE part of the counter. The marble runs across the MIDDLE of the picture BEHIND their shoulders. BEYOND it stands ABBY, facing them across the bar, the counter's far edge crossing in front of her at the waist and hiding her below it — she is standing and they are seated, so her head sits HIGHER in the frame than theirs. Behind her, the back bar, the television above it and the chalkboard beside. The television picture shows A flat, obedient line and an anchor caught mid-nod. They are seated at the bar, never at a table, and never lined up shoulder to shoulder. Each character is seen in three-quarter view with the face and both eyes readable, and NOBODY looks out of the panel at the reader.",
