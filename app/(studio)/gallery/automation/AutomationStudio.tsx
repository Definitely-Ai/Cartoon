...
export default function AutomationStudio({ canManage, initialNow, examples }: Props) {
  ...
  return <main id="content" className="automation-page">
    ...
    <section className="automation-evidence" aria-labelledby="evidence-heading"><div className="automation-section-title"><span>05 / What is already demonstrated</span><h2 id="evidence-heading">Built on real production work.</h2></div>
      ...
      <p className="automation-small">Those historical automation proofs used earlier cast studies and editorial revisions. The current gallery shows the visual benchmark, not a claim that every selected cartoon was produced unattended.</p>
    </section>
    ...
    <footer className="automation-footer"><Link href="/gallery/best-of">Explore the selected cartoons →</Link><span>One fixed set. Location-specific ideas. A deliberate quality check.</span></footer>
  </main>;
}
